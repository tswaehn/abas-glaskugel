...
/*
  ...
  function getBestellung( $abas_nr ){
    global $pdo;
    
    $table="Einkauf:Bestellung";
  ...
  */
  function getAllParentsByAbas( $abas_nr, $show_all ){
    ...
    $sql = "SELECT artikel,nummer FROM ".q($table)." WHERE ( nummer = :abas_nr );";
  ...
  function getAllParents( $article_id, $show_all ){  
    ...
    $sql = "SELECT article_id,nummer FROM ".q($table)." WHERE ( nummer = :article_id );";
